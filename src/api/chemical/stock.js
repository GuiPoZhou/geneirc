...
export function queryStoreList(params) {
	return request({
		url: "/material/v1/store/queryStoreList",
		method: "get",
		params
	})
}
...
export function queryStoreChangeList(params) {
	return request({
		url: "/material/v1/storeChange/queryStoreChangeList",
		method: "get",
		params
	})
}
...
export function addStoreChange(data) {
	return request({
		url: "/material/v1/storeChange/addStoreChange",
		method: "post",
		data
	})
}
...
export function queryStoreChangeDetail(storeChangeId) {
	return request({
		url: `/material/v1/storeChange/queryStoreChangeDetail/${storeChangeId}`,
		method: "get",
	})
}
// 导出
export function exportStoreChange(query) {
  return request({
    url: '/material/v1/storeChange/export',
    method: 'get',
    params: query
  })
}
