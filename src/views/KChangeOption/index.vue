<template>
  <div class="option-change-container">
    <a-row v-if="type === 'tabs'" :gutter="8">
      <div class="option-change-box" v-for="(val, index) in value" :key="index">
        <a-col :span="9">
          <a-input v-model="val.key" placeholder="标签Key"/>
        </a-col>
        <a-col :span="9">
          <a-input v-model="val.tabName" placeholder="标签名称"/>
        </a-col>
        <a-col :span="6">
          <div @click="handleDeleteTabs(index)" class="option-delete-box">
            <a-icon type="delete" />
          </div>
        </a-col>
      </div>
      <a-col :span="24"><a @click="handleAddTabs">添加</a></a-col>
    </a-row>
    <a-row v-if="type === 'option'" :gutter="8">
      <div class="option-change-box" v-for="(val, index) in value" :key="index">
        ...
        /></a-col>
        <a-col :span="9"><a-input-number v-model="val.value" placeholder="值"/></a-col>
        <a-col :span="6"
