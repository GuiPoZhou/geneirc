...
<template>
  <div class="operating-area">
    ...
    <div class="left-btn-box">
      <el-button type="primary" v-if="toolbars.includes('save')"  @click="$emit('handleSave')" size="mini" round>保存</el-button>
      <el-button type="primary" v-if="toolbars.includes('preview')"  @click="$emit('handlePreview')" size="mini" round>预览</el-button>
      <el-button type="primary" v-if="toolbars.includes('exportJson')"  @click="$emit('handleOpenJsonModal')" size="mini" round>生成Json</el-button>
<!--      <a-tooltip title="保存">-->
