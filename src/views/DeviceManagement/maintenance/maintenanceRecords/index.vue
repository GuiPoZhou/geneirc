  ...
  <div class="app-container">
    <div class="a-c-top">
      <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
        ...
        <el-menu-item index="2">维护保养记录</el-menu-item>
      </el-menu>
    </div>
    <!--待执行计划-->
    <waitPlan ref="waitPlan" v-if="activeIndex === '1'" @implement="implement"></waitPlan>
    <!--维护保养记录-->
    <record ref="record" v-if="activeIndex === '2'" @lookDetail="lookDetail"></record>
    <!--执行-->
...
<script>
  ...
  import {getMaintainRecordDetail} from '@/api/resources/deviceManagement/index.js'
  ...
  export default {
    ...
    methods: {
      ...
      getDetails(id, type) {
        this.showimplement = true
        getMaintainRecordDetail(id).then(res => {
          this.$nextTick(() => {
