    ...
    <el-tabs v-model="activeName" @tab-click="handleClick" type="card">
      <el-tab-pane label="文件更改申请" name="first">
        ...
        >
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="申请部门" prop="standardNameCn">
                <el-input
                    placeholder="请输入申请部门"
                    v-model="queryParams.standardNameCn"
                    disabled
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item
                  ...
                  style="width: 90%"
              >
                <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="queryParams.changeClause" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="更改后内容" prop="afterChangeContent" style="width: 90%">
                <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="queryParams.afterChangeContent" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="通知范围" prop="noticeRange" style="width: 90%">
                <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="queryParams.noticeRange" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
