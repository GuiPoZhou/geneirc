    ...
    <el-tabs v-model="activeName" @tab-click="handleClick" type="card">
      <el-tab-pane label="设备维修申请" name="first">
        ...
        >
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="维修申请日期" prop="applyDate" style="width: 90%">
                <el-input placeholder="请输入维修申请日期" v-model="queryParams.applyDate" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="维修申请人员" prop="applyPerson" style="width: 90%">
                <el-input placeholder="请输入维修申请人员" v-model="queryParams.applyPerson" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="设备简介" prop="introduce" style="width: 95%">
                <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="queryParams.introduce" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="录入日期" prop="createTime" style="width: 90%">
