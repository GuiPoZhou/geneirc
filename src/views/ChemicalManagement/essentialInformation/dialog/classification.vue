<template>
  <div class="a-c-top">
    ...
    <div class="btnbox" v-if="showTypes !== 'details'">
...
<script>
  import {addMaterialtree, deleteMaterialtree, editMaterialtree} from '@/api/chemical/essentialInformation.js'
    ...
    methods: {
      ...
      handleOk() {
        this.$refs.queryForm.validate((valid) => {
          if (valid) {
			...
			addMaterialtree(params).then(res => {
                if (res.code === 200) {
              ...
              editMaterialtree(params).then(res => {
                if (res.code === 200) {
                  this.isloading = false
      ...
      handleDel () {
        this.$confirm("确认删除吗?", "提示", {
          ...
          deleteMaterialtree(this.choiceData.id).then(res => {
            if (res.code === 200) {
