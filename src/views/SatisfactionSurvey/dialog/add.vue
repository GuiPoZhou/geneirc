<template>
    <div>
        ...
        <addText ref="addText" v-if="showaddText" @close="showaddText = false" @save="e_saveText" />
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            widgetId: 'satisfactionSurvey_module_form', // 记得对应好低码唯一键
    ...
    methods: {
        e_saveText(data) {
            new Function('ctx', '_this', 'data', this.KevinJson.KevinWidget.manuallyEvents.saveText)(this, this.$refs.KevinRender, data)
        },
        init() {
