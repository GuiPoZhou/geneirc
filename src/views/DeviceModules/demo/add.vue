<template>
    <div>
        ...
        <div v-for="(item, index) in KevinLogWidgets" :key="index">
            <log  :ref="item.WIDGETID" />
        </div>
    ...
    methods: {
        ...
        async e_getWidgetInfo() {
            ...
            try {
                ...
                this.KevinLogWidgets = KevinJson.KevinLogWidgets
                console.log('this.KevinLogWidgets ', this.KevinLogWidgets)
                this.KevinLogWidgets.forEach(kl => {
                    this.logShow[kl.WIDGETID] = false
                })
