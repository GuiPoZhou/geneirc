...
export default {
    data() {
        return {
            ...
            widgetId: 'device_asseptance_info', // 记得对应好低码唯一键
    ...
    methods: {
        ...
        async editInit(row) {
            ...
            new Function('ctx', "_this", 'mainTableData', this.KevinJson.KevinWidget.manuallyEvents.getDeviceAcceptInfo)(this, this.$refs.KevinRender, row)
        },
