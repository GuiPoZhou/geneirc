  ...
  <div class="app-container">
    ...
    <div class="a-c-bottom">
      ...
      <el-table v-loading="loading" :data="Modeler" border
        ...
        <el-table-column label="所属分类" align="center" prop="category"  :show-overflow-tooltip="true" />
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="text"
              icon="icon iconfont iconbsl-icon-guaqi"
              @click="suspendOrActiveApply(scope.row)"
            >{{scope.row.suspendState==='1'?'挂起':'激活'}}</el-button>
            <el-button
              size="mini"
              type="text"
              icon="icon iconfont iconbsl-icon-zhuanmoxing"
