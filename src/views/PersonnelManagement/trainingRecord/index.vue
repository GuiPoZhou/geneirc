  ...
  <div class="app-container">
    ...
    <div class="a-c-bottom" :class="fullscreen == true ? 'showFullScreen' : ''">
      ...
      >
        ...
        <el-table-column prop="recordNo" label="编号" align="center" sortable show-overflow-tooltip v-if="colData[0].istrue"/>
        <el-table-column prop="trainPerson" label="培训人" align="center" sortable show-overflow-tooltip v-if="colData[1].istrue"/>
        <el-table-column prop="trainTitle" label="培训主题" align="center" width="500" sortable show-overflow-tooltip v-if="colData[2].istrue"/>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        colData: [
          ...
          { title: "培训人", istrue: true },
          { title: "培训主题", istrue: true },
    ...
    methods: {
      ...
      // 列表
      getList () {
        getTrainRecordList(this.queryParams).then(res => {
      ...
      // 获取详情
      getdetail (id, type) {
        getTranrecordDetail(id).then(res => {
          this.$nextTick(() => {
      ...
      handleExport() {
        ...
        exportTrainRecord(this.queryParams).then(res => {
          if (res.code === 200) {
