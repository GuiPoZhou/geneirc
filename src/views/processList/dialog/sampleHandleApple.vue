<template>
    <div style="padding: 20px">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item label="申请日期" prop="submitTimestr">
                        <el-date-picker v-model="queryParams.submitTimestr" value-format="yyyy-MM-dd" disabled type="date" placeholder="选择日期" style="width: 100%">
                        </el-date-picker>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="检测完成情况" prop="checkDesc">
                        <el-input placeholder="请输入内容" v-model="queryParams.checkDesc" disabled></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="24">
                    <el-form-item label="处理方法" prop="handleDesc">
                        <el-input placeholder="请输入内容" v-model="queryParams.handleDesc" disabled></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="24">
                    <el-form-item label="备注" prop="remarks">
                        <el-input placeholder="请输入备注" v-model="queryParams.remarks" disabled></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
