<template>
    <BoDialog ref="BoDialog" :dia-log-show="showlog" dia-log-title="上传图片(建议图片最小分辨率为1920*1080)" dia-log-width="80%" @close="e_close"
              :can-edit-full-screen="false">
        <template slot="bologbody">
            <el-row>
                <el-col :xs="24" :style="{height: '1100px'}">
                    <vue-cropper
                        ref="cropper"
                        :img="options.img"
                        :info="true"
    ...
    methods: {
        ...
        uploadImg() {
            this.$refs.cropper.getCropBlob(async data => {
                ...
                this.$net('/v1/theme/saveThemeSkin','post',{themeSkin:blobToBase64}).then(re=>{
