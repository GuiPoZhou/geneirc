    ...
    <div class="app-container">
        ...
        <div class="a-c-top" v-show="showSearch">
            ...
            <el-form :inline="true" ref="queryForm" :model="queryParams" class="demo-form-inline" v-show="showSearch"
                ...
                <el-form-item label="检测类别" prop="detectCategory">
                    <el-input v-model="detectCategoryName" @clear="resetDetectCategory" @focus="categoryShow=true"
        ...
        <div class="a-c-bottom">
            ...
            <el-row :gutter="10" class="mb8">
                ...
                <el-col :span="1.5">
                    <el-button type="warning" icon="icon iconfont iconbsl-icon-daochu" size="mini"
                ...
                <el-table-column fixed="right" label="操作" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button size="mini" type="text" icon="el-icon-delete"
                                   @click="deleteItem(scope.row.itemNameCn,scope.row.id)"
                                   v-show="scope.row.status">删除
                        </el-button>
        ...
        <itemMethodAdd :addShow.sync="addShow" @reload="initList" :operateType="operateType" ref="itemMethodAdd"/>
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
              ...
              this.$nextTick(() => {
                this.$refs.itemMethodAdd.resetAdd()
              })
            },
