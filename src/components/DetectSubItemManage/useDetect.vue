    ...
    <div class="useDetect">
        <el-row>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="类别名称" prop="detectName">
                                <el-input style="width: 150px" v-model="form.detectName" clearable @clear="e_getDetectList" @keyup.enter.native="e_getDetectList"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
            ...
            <el-col :span="16" style="padding: 10px">
                <itemList ref="itemList" @parseSelectedItems="parseSelectedItems"
