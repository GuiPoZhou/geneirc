                ...
                <el-tab-pane label="新增表单" name="form">
                    <el-tabs v-model="activeFormType">
                        <el-tab-pane label="固定字段" name="fixed">
                            <FixedForm @confirm="e_confirmFixedAdd"/>
                        </el-tab-pane>
                        ...
                        >
                            <template slot-scope="scope">
                                <el-select v-model="scope.row.editType" clearable>
                                    <el-option label="span" value=""></el-option>
    ...
    methods: {
        ...
        e_delteButton(index) {
            this.$confirm('确定删除该按钮？').then(() => {
                this.buttonInfo.buttonList.splice(index, 1)
            })
        },
        /**
         * @author Coder
        ...
        e_addNewButton() {
            ...
            this.buttonInfo.buttonList.push(params)
        },
        /**
         * @author Coder
         * @date 2023/3/24
