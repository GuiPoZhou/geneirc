...
export default {
    ...
    methods: {
        ...
        renderELTable(item, index) {
            console.log('treeProps',item.treeProps)
            if (item.isHide == true) {
                return ('')
            }
            /**
        ...
        renderTableSelect(columnInfo, scope) {
            return (
                columnInfo.valueType == 'fixed' ?
                    <el-select v-model={scope.row[columnInfo.prop]} placeholder="请选择" onChange={() => {
                    ...
                    </el-select> : <el-select v-model={scope.row.extData[columnInfo.prop]} placeholder="请选择" onChange={() => {
                        columnInfo.events && columnInfo.events.change ? eval(columnInfo.events.change) : ''
                    }}>
                        {
                            columnInfo.options.options.map(optioninfo => {
