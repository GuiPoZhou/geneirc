<template>
    <el-dialog title="拍照" :visible.sync="dialogShow" @clos="close" width="50%" append-to-body :close-on-click-modal="false">
        <!-- 高拍仪视频预览区 -->
        <div id="comareamain">
        ...
        <!-- 缩略图 -->
        <div class="suoluetu">
            <div class="sl-list" v-for="(v, i) in suoluelist" :key="i">
                <el-image style="width: 100px; height: 100px" :preview-src-list="[v]" :src="v"></el-image>
                <i class="el-icon-delete  kil-icon ki-delete" @click="deletesuolueImage(i)"></i>
            </div>
        </div>
        <div>
            <el-button @click="view1_scan(0)" size="small">主摄像头拍照</el-button>
            <el-button @click="view2_scan(1)" size="small">副摄像头拍照</el-button>
            <el-button @click="open_view1(0)" size="small">打开主摄像头</el-button>
            <!-- <el-button @click="close_view1(1)" size="small">关闭主摄像头</el-button> -->
            <el-button @click="open_view2(1)" size="small">打开副摄像头</el-button>
