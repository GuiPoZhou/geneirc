<template>
    <div class="buttonEdit">
        <div class="be-right">
            <el-form :model="signleParams" ref="signleParams" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="按钮名称" prop="label" :rules="[{ required: true, message: '按钮名称不能为空', trigger: 'blur' }]">
                    <el-input v-model="signleParams.label"></el-input>
                </el-form-item>
                <el-form-item label="按钮尺寸" prop="size" :rules="[{ required: true, message: '请选择按钮大小', trigger: 'change' }]">
                ...
                <el-form-item label="按钮类型" prop="type" :rules="[{ required: true, message: '请选择按钮类型', trigger: 'change' }]">
                ...
                <el-form-item label="按钮事件" prop="events"
                    :rules="[{ required: true, message: '按钮事件不能为空', trigger: 'change' }]">
