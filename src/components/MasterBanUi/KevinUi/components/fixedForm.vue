    ...
    <div class="fixedForm">
        <el-form :model="form" ref="form" label-width="210px" class="demo-ruleForm">
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="表单项名称（label）" prop="label" :rules="[ { required: true, message: '请选择主表字段', trigger: 'change' }]">
                        <el-input v-model="form.label"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="表单项键名（prop）" prop="prop" :rules="[ { required: true, message: '请选择主表字段', trigger: 'change' }]">
