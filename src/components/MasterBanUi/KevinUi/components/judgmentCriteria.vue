        ...
        <el-row>
          <el-col :span="9" style="padding-right: 10px">
            ...
            <el-table :data="categoryList" ref="categoryList" style="width: 100%" @selection-change="selRow" border
                      :row-key="getRowKey" :tree-props="{children: 'itemLimitList'}" empty-text="暂无数据"
          ...
          <el-col :span="15">
            ...
            <el-table :data="tableList" ref="multipleTableDevice" style="width: 100%" border
              ...
              <el-table-column prop="itemCode" label="方法编号" show-overflow-tooltip align="center"/>
              <el-table-column prop="subname" label="方法名称" show-overflow-tooltip align="center"/>
              <el-table-column prop="productionName" label="执行标准" align="center">
