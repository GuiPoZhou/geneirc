        ...
        <el-drawer :visible.sync="showDrawer" :append-to-body="true" :close-on-press-escape="false" :wrapperClosable="false"
            ...
            <div class="scriptallarea">
                <div class="sa-left">
                    ...
                    <el-button style="margin-bottom: 4px;" size="mini" type="primary"
                        @click="e_addClickEvents">新增手动执行脚本</el-button>
                    <el-table :data="events" style="width: 100%">
                        <el-table-column prop="label" label="事件名称">
                        </el-table-column>
                        <el-table-column prop="value" label="事件脚本" show-overflow-tooltip>
                        </el-table-column>
                    ...
                    <el-button style="margin-bottom: 4px;" size="mini" type="primary"
                        @click="e_addopenEvents">新增自动执行脚本</el-button>
                    ...
                    <el-table :data="bodyButtons" style="width: 100%">
                        ...
                        <el-table-column prop="events" label="按钮事件" show-overflow-tooltip>
                        </el-table-column>
                        <el-table-column label="操作">
                            <template slot-scope="scope">
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            let saveParams = { events: events, openEvents: openEvents, anchorPoint: this.anchorPoint, bodyButtons: this.bodyButtons }
