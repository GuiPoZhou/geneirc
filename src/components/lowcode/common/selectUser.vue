<template>
  <el-dialog title="选择人员" :visible.sync="visible" append-to-body width="800px" center :close-on-press-escape="false"
    :close-on-click-modal="false" @close="close">
    <el-form ref="queryForm" :model="queryParams" @submit.native.prevent :inline="true">
      <!-- 搜索栏 -->
      <el-form-item label="所属部门" prop="deptName">
        <el-input @keyup.enter.native="handleQuery" v-model="deptName" size="small" placeholder="请输入所属部门"
          @focus="deptShow = true" suffix-icon="el-icon-search">
        </el-input>
      </el-form-item>
      <el-form-item label="人员姓名" prop="nickName">
        <el-input @keyup.enter.native="handleQuery" v-model="queryParams.nickName" clearable size="small"
          placeholder="请输入人员姓名">
        </el-input>
      </el-form-item>
      <el-form-item>
    ...
    <!-- 表格 -->
    <div>
      <el-table height="500" :data="userList" ref="multipleTable" @selection-change="handleSelectionChange">
...
export default {
  ...
  methods: {
    ...
    commit() {
      ...
      this.$emit("save", this.multipleList[0]);
      this.close();
    },
    //清空所有选中
    clearAll() {
